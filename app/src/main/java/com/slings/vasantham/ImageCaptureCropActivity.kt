...
import com.slings.vasantham.databinding.ExtendedActivityBinding

internal class ImageCaptureCropActivity : CropImageActivity() {
...
//    Timber.tag("AIC-Sample").i("Output uri: ${result.getUriFilePath(this)}")
    Util.profileUri = result.uriContent
