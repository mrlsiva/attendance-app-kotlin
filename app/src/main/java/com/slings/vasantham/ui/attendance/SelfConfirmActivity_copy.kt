...
class SelfConfirmActivity_copy : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        imageByteArray = intent.getByteArrayExtra("capturedImage")!!
...
//        }
        ...
        // Set up the "Re-take" button click listener
    ...
    private fun showProgressDialog() {
        ...
        val backgroundTask = Runnable {
            handler.post {
                val builder = AlertDialog.Builder(this@SelfConfirmActivity_copy)
    ...
    fun attendenaceIn() {
        val imageByteArray =
            readImageFileToByteArray() // Replace with your method to read the image file
        ...
        val requestBody: RequestBody = MultipartBody.Builder()
            ...
            .addFormDataPart("imageUrl", intent.getStringExtra("imagename"), createRequestBody(imageByteArray))
            .build()
    ...
    private fun readImageFileToByteArray(): ByteArray {
        // Replace this with your logic to read the image file and convert it to a ByteArray
        // For example, you can use FileInputStream to read the file.\

        val fileInputStream = FileInputStream(File(intent.getStringExtra("imageURL")))
...
/* fun attendenaceIn() {
     // Get a reference to the ProgressBar in your activity
...
// Inside a coroutine or background thread
     try {
