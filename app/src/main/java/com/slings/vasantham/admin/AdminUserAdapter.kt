...
class AdminUserAdapter(private val context: Context, items: List<CustomItem>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view: View = LayoutInflater.from(context).inflate(R.layout.admin_user_list_adapter, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.textButton.setOnClickListener { v: View? ->
     /*       val fragmentB = AdminDashFragment()
            ...
            transaction.commit()
*/
            MainActivity.navController.navigate(R.id.nav_admin_user_dashboardfragment)
        }
        holder.roundedButton.setOnClickListener { v: View? ->
            MainActivity.navController.navigate(R.id.nav_admin_user_dashboardfragment)
        }
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        var user_layer:ConstraintLayout
        ...
        init {
            ...
            user_layer = itemView.findViewById(R.id.user_layer)
        }
    }
}
